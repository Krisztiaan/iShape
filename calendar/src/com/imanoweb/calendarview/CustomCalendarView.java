...
public class CustomCalendarView extends LinearLayout {
    ...
    private void getAttributes(AttributeSet attrs) {
        ...
        dayOfWeekTextColor = typedArray.getColor(R.styleable.CustomCalendarView_dayOfWeekTextColor, getResources().getColor(R.color.selected_day_background));
        dayOfMonthTextColor = typedArray.getColor(R.styleable.CustomCalendarView_dayOfMonthTextColor, getResources().getColor(R.color.selected_day_background));
    ...
    private void initializeCalendar(final HashMap<Long, String> markedDays) {
        ...
        previousMonthButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                refreshCalendar(currentCalendar, markedDays);
        ...
        refreshCalendar(currentCalendar, markedDays);
        markDayAsSelectedDay(currentCalendar.getTime());
    }
    ...
    private void initializeWeekLayout() {
        ...
        final String[] weekDaysArray = new DateFormatSymbols(locale).getWeekdays();
        for (int i = 1; i < weekDaysArray.length; i++) {
            ...
            dayOfWeek.setTextColor(getResources().getColor(R.color.selected_day_background));
    ...
    private void setDaysInCalendar(HashMap<Long, String> markedDays) {
        ...
        for (int i = 1; i < 43; i++) {
            ...
            if (isSameMonth(calendar, startCalendar)) {
                ...
                dayView.setBackground(getResources().getDrawable(R.drawable.tile_bg));
                dayView.setTextColor(dayOfWeekTextColor);
            } else {
                dayView.setTextColor(disabledDayTextColor);
                dayView.setBackgroundColor(getResources().getColor(android.R.color.white));
    ...
    @SuppressLint("DefaultLocale")
    public void refreshCalendar(Calendar currentCalendar, HashMap<Long, String> markedDays) {
    ...
    private OnClickListener onDayOfMonthClickListener = new OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            calendar.setFirstDayOfWeek(getFirstDayOfWeek());
            calendar.setTime(currentCalendar.getTime());
            calendar.set(Calendar.DAY_OF_MONTH, Integer.valueOf(dayOfMonthText.getDay().toString()));
